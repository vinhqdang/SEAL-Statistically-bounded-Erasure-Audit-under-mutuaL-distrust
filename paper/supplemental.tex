...
\begin{align*}
\bigl|\Pr[A(Q_i){=}1]-\Pr[A(Q_j){=}1]\bigr| &\le \epsilon_1+\epsilon_2 \\
&\le 2\max(\mathrm{Adv}_{B_1},\mathrm{Adv}_{B_2}) \\
&= 2\,\mathrm{Adv}_{\text{IND-CPA}}(B),
\end{align*}
...
\begin{theorem}
Writing $Q$ for the auditor's checked $P$-subset and $T$ for the adversary's tampered $m$-subset,
\[
\Pr[Q \cap T = \emptyset] = \binom{N-m}{P}\Big/\binom{N}{P}.
\]
\end{theorem}
